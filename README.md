...
# 📖 [Odin Recipes - Code review practice project] <a name="about-project"></a>


**[Odin Recipes - Code review practice project]** is my first project to do the code review practice.
